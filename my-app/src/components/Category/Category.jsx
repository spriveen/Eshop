    ...
    <div className='py-8'>
        <div className='container'>
         <div className="grid grid-cols-1 sm:grid-cols-2  lg:grid-cols-4 gap-8">
            ...
            {/* second col */}
            <div className='py-10 pl-5 bg-gradient-to-br from-yellow-700
            90 to-yellow-300/90 text-white rounded-3xl relative h-[320px]
            flex items-end'>
               <div>
                <div className='mb-4'>
            ...
            {/* third col */}
            <div className='col-span-2 py-10 pl-5 bg-gradient-to-br from-red-700
            90 to-red-500/90 text-white rounded-3xl relative h-[320px]
            flex items-end'>
               <div>
                <div className=' mb-4'>
